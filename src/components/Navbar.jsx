  ...
  return (
    <header 
      ...
      style={{
        ...
        right: 0,
        zIndex: 900,
        backgroundColor: scrolled ? 'rgba(246, 239, 228, 0.72)' : 'rgba(246, 239, 228, 0.55)',
        backdropFilter: 'blur(20px) saturate(180%)',
        WebkitBackdropFilter: 'blur(20px) saturate(180%)',
        borderBottom: '1px solid rgba(255, 255, 255, 0.45)',
        boxShadow: scrolled ? '0 10px 30px rgba(74, 52, 40, 0.08)' : '0 4px 20px rgba(74, 52, 40, 0.03)',
      ...
      {mobileMenuOpen && (
        <div 
          style={{
            ...
            left: 0,
            right: 0,
            backgroundColor: 'rgba(246, 239, 228, 0.92)',
            backdropFilter: 'blur(16px)',
            WebkitBackdropFilter: 'blur(16px)',
            borderBottom: '1px solid rgba(74, 52, 40, 0.1)',
            boxShadow: '0 12px 30px rgba(74, 52, 40, 0.08)',
            padding: '2rem 1.5rem',
            display: 'flex',
